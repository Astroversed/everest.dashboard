                ...
                <div class="match-board">
                    ...
                    <section class="match-lane match-lane--emoji" aria-label="${t('matchEmojiLabel')}">
                        ...
                        <div class="match-column__list">
                            ${question.emojiChoices.map((option) => `<button class="choice-button choice-button--match ${normalizeWord(option.en) === state.matchSelection.emoji ? 'is-selected' : ''}" data-match-side="emoji" data-match-value="${option.en}" type="button" style="display:grid !important;grid-template-columns:auto minmax(0,1fr) !important;align-items:center !important;column-gap:1.04rem !important;padding:.7rem .84rem !important;"><span class="choice-button__media" style="display:grid !important;justify-items:center !important;align-content:center !important;gap:.1rem !important;"><span class="choice-button__kicker" style="display:inline-flex !important;align-items:center !important;justify-content:center !important;min-width:2rem !important;min-height:1.18rem !important;padding:0 .35rem !important;">${option.laneLabel}</span><span class="choice-button__emoji" style="font-size:1.88rem !important;line-height:1 !important;">${option.emoji}</span></span><span class="choice-button__copy" style="display:grid !important;align-content:center !important;gap:.14rem !important;min-width:0 !important;"><span class="choice-button__title" style="font-size:1.3rem !important;line-height:1.16 !important;font-weight:800 !important;">${option.es}</span><span class="choice-button__detail" style="font-size:.9rem !important;line-height:1.24 !important;font-weight:700 !important;">${option.hint}</span></span></button>`).join('')}
                        </div>
                    </section>
                </div>
            </div>
